...
from data_collection import get_error_message, get_results_stackoverflow
...
if __name__ == "__main__":
    print(get_answer("Pip install dot env error code 1 windows 10"))